...
VITPOSE_ABSOLUTE_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "third-party/ViTPose")

sys.path = [p for p in sys.path if not ('mmcv' in p or 'mmpose' in p)]

paths = [
    os.path.join(VITPOSE_ABSOLUTE_PATH, "mmcv_custom"),
    os.path.join(VITPOSE_ABSOLUTE_PATH, "mmpose"),
    VITPOSE_ABSOLUTE_PATH
]
...
ROOT_DIR = "./"
VIT_DIR = os.path.join(ROOT_DIR, "src/third-party/ViTPose")
