> ⚠️ **PLEASE NOTE: Modified and Integrated Version of YOWOv2**
> 
> This folder contains a modified version of the original YOWOv2 repository.
> The code has been adapted to work in this thesis use case scenario.

### 🛠️ Modifications to the Original Repository

To guarantee full compatibility with the rest of the work, some modifications to hardcoded values, paths and evaluation methods were made. To see details regarding such modifications, please refer to the thesis work.

---

*(Original YOWOv2 README below)*
